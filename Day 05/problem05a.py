...
# strange; after each jump, the offset of that
# instruction increases by 1. So, if you come
# across an offset of 3, you would move three
# instructions forward, but change it to a 4 for
