...
#
# After following the directional steps, how many
# steps away is the furthest point away from the
# starting position?
...
if __name__ == '__main__':
   ...
   # and a list of distances after each step.
   x = y = z = 0
   distances = list()
