...
# notice you before you leave.) The severity of
# getting caught on a layer is equal to its depth
# multiplied by its range. (Ignore layers in which
# you do not get caught.) The severity of the
# whole trip is the sum of these values.
#
# If you leave immediately (entering layer 0 at
# time 0, what is the severity of your whole trip?
...
if __name__ == '__main__':
   ...
   for location, scan_range in layers:
      ...
      if (location % period) == 0:
         # If so, then add to the severity.
         severity += location * scan_range
