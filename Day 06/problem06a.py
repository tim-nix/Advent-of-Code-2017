...
# input, how many redistribution cycles must be
# completed before a configuration is produced
...
if __name__ == '__main__':
   ...
   # occurs that has been seen before.
   seen_states = set()
   ...
   # Display the number of cycles needed to repeat
