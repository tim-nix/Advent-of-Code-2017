...
#
# What letters will the program see (in the order
# it would see them) if it follows the path?
...
if __name__ == '__main__':
   ...
   # Display the sequence of letters as traversed.
   print("Recovered string = " + str(string))
